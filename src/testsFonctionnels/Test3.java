...
public class Test3 {
	public static void main(String[] args) {
		...
		System.out.println("Sommet de la pile est une début de limite");
		...
		System.out.println("On ajoute le v�hicule prio "+joueur5.estBloque());
		...
		ensembleBotte.clear();
		System.out.println("On a effac� les bottes "+joueur5.estBloque());
